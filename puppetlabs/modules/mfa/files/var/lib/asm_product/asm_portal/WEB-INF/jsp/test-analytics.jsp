...
<body class="nof-centerBody" onLoad="javascript:onLoadRunction();">
					...
					<table style="border:1px single black">
						<tr>
							<td width ="200px" style="background:#ded9c3;" valign="top">
								<form id="viewAnalyticsReport" method="get" action="javascript:generateReport();">
								<table width="100%">
									<tr>
									<br/>
										<td colspan="2">
											<b>Report Type:</b>
											<br/>											
											<select name="asmReportType" style="width:200px;">
							...
							<table cellspacing="3" width="100%">
								...
								<tr>
									...
									<td><div class="shadowBorder" id="failedChallengedChart">
										<p class="chartText">Failed Challenged Transactions</p>
									</div></td>								
								</tr>
								<tr>
...
function clearCharts(){
	...
	$("#failedChallengedChart").html("<p class='chartText'>Failed Challenged Transactions</p>");
...
/*     var data = google.visualization.arrayToDataTable([
  ...
  function printChartsFromPayLoad(payLoadMap){
    ...
    //(4) Get Failed challenges by type - FAILED_CHALLENGE_DATA
      ...
      drawChart("failedChallengedChart", "Failed Challenged Transactions", 
  ...
  function getNotEvalDataArray(payLoad){
	    ...
	    dataArray[0] = ['Day', 'Invalid email', { role: 'annotation' },'Bad request', { role: 'annotation' },
	                    'Invalid Policy API Key', { role: 'annotation' },'Invalid Svr IP', { role: 'annotation' },
  ...
  function getFailedChallengeDataArray(payLoad){
    ...
    function drawPieChart(divId, title, dataArray ){
	  ...
	  function drawChart(divId, title, dataArray, total, colorsArr ){
		      ...
		      var chartwidth = ($("body").innerWidth()*.46)-100;
		      
	  	      
	  	          chart.draw(data,
	  	               {title:title+"\nTotal: "+ total,  titleTextStyle: {color: '#6E6666',fontName: 'Arial', fontSize: 13},
	  /*  	                series: {0:{color: '#AE120E', visibleInLegend: true},1:{color: '#E22722', visibleInLegend: true}},
